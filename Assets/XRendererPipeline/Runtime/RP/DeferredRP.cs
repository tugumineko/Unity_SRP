...
namespace SRPLearn{
    ...
    public class DeferredRP : BaseRP
    {
        ...
        private void AcquireDepthTextureIfNot(ScriptableRenderContext context, Camera camera){
            ...
            if(!_depthTexture){
                RenderTextureDescriptor depthDesc = new RenderTextureDescriptor(camera.pixelWidth,camera.pixelHeight,RenderTextureFormat.Depth,24,1);
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            this.ReleaseGBuffers();
            this.ReleaseDepthTexture();
            this.ReleaseARGB32Texture(ref _skyTexture);
            this.ReleaseAOSATextures();
            this.ReleaseARGB32Texture(ref _softBlurTexture);
            this.ReleaseARGB32Texture(ref _softBlurTexture2);
            this.ReleaseARGB32Texture(ref _heavyBlurTexture);
            this.ReleaseARGB32Texture(ref _heavyBlurTexture2);
            this.ReleaseARGB32Texture(ref _colorTexture);
