...
namespace CustomLensFlare
{
    ...
    public class FlareData
    {
        ...
        [Min(0f)] public int AtlasIndex = 0;
        [Range(0f, 2f)] public float FlareScale = 0.5f;
        [Range(-1f, 2f)] public float FlareOffset = 0.2f;
        [Range(0f, 1f)] public float OcclusionScale = 1f;
        [ColorUsage(true, true)] public Color FlareColor = Color.white;
    }
    ...
    [CreateAssetMenu(fileName = "CustomLensFlareAsset", menuName = "SRPLearn/CustomLensFlareAsset")]
